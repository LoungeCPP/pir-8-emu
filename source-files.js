...
sourcesIndex["pir_8_emu"] = {"name":"","dirs":[{"name":"isa","dirs":[{"name":"instruction","files":["display.rs","instruction.rs","mod.rs"]},{"name":"register","files":["general.rs","mod.rs","special.rs"]}],"files":["mod.rs"]}],"files":["cpu.rs","lib.rs","util.rs"]};
createSourceSidebar();
